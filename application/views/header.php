    ...
    <div class="header_main">
      <div class="mobile_menu">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="logo"><a href="index.html"><img src="<?php echo base_url(); ?>/assets/images/logo.png" lt="Inicio" width="150px"> </a></div>
      ...
      <div class="container-fluid">
        <div class="logo"><a href="index.html"><img src="<?php echo base_url(); ?>/assets/images/logo.png" Alt="Inicio" width="150px"></a></div>
        <div class="menu_main">
          <ul>
